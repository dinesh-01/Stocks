...
{foreach $datas as $value name=count}
    ...
    <tr class="show">
        ...
        <td><a href="order_equity_sell_execute.php?id={$value.order_id}"><button value="sell">SELL</button></a></td>
        <td><a href="order_equity_delete_execute.php?id={$value.order_id}"><button value="delete">DELETE</button></a></td>
    </tr>
