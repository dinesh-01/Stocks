...
require_once './include/common.php';
   ...
   //Update order status
   $query  = "INSERT INTO optionAmo( symbol, quanity, trigger_value, stop_loss_value, track_status, created_date) VALUES ('$symbol','$quantity','$trigger_value','$stoploss_value','Order Executed','$date')";
