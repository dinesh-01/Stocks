...
$field     =  array("id,order_id,sl_order_id,symbol,price,quanity,stop_loss,target,iceberg_leg,created_date");
$table     =  "optionAmo";
       ...
       if($status != 'COMPLETE') {
           ...
           if($target < $last_price) {
               ...
               */
               ...
               $query = "UPDATE `optionAmo` SET `status`= 'completed' WHERE id = '$id'";
