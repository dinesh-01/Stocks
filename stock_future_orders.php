...
foreach ($datas as $data) {
    ...
    $datas[$i]['lot'] =  $data['lot_size'];
    $datas[$i]['margin'] = $data['lot_size'] * $last_price;


    $query  = "Select id from futureAmo where symbol='$tradingsymbol'";
    $result = mysqli_query($GLOBALS['mysqlConnect'],$query);
...
$smarty->display("show_future_orders.tpl");
