...
foreach ($datas as $data) {
    ...
    if(str_contains($tradingsymbol,"&")) {
        $stock_tradingsymbol = str_replace("&", "%26", $tradingsymbol);
        $end_point = "https://api.kite.trade/quote?i=NSE:$stock_tradingsymbol";
    }else{
    ...
    $datas[$i]['stock_symbol'] = $tradingsymbol;
...
$smarty->display("stock_equity_execution.tpl");
