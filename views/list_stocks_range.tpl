...
{foreach $datas as $value name=count}
   ...
   <!-- https://in.tradingview.com/chart/AINnrOTv/?symbol=NSE%3A{$value.cSymbol|replace:'-':'_'}1%21
    <br/>
    -->
    ...
    <tr class="show">
        ...
        <td><a href="https://in.tradingview.com/chart/AINnrOTv/?symbol=NSE%3A{$value.cSymbol|replace:'-':'_'}" target="_blank">Single Layout</a></td>
